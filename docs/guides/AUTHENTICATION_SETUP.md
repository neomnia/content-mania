...
\`\`\`env
DATABASE_URL=postgresql://neondb_owner:npg_cRzIrOmJwo38@ep-calm-lab-agkv7stu-pooler.c-2.eu-central-1.aws.neon.tech/neondb?sslmode=require
...
**Note**: The script is in `db/push-schema.ts` and uses the Neon HTTP driver for serverless environments.
...
/db
  ...
  push-schema.ts     # Script to push schema to database
  migrate.ts         # Migration script (alternative method)
