    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="users" className="space-y-4">
        <TabsList className="grid w-full grid-cols-2">
          <TabsTrigger value="users" className="data-[state=active]:bg-[#CD7F32] data-[state=active]:text-white">
            <Users className="mr-2 h-4 w-4" />
            Users
          </TabsTrigger>
          <TabsTrigger value="companies" className="data-[state=active]:bg-[#CD7F32] data-[state=active]:text-white">
