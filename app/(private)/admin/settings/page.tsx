...
export default function AdminSettingsPage() {
  ...
  }, [siteName, siteUrl, contactEmail, gdprContactName, logoDisplayMode, maintenanceMode, gtmCode, customHeaderCode, customFooterCode, customHttpHeaders, adminFooterCopyright, forceHttps, seoSettings, socialLinks])
  ...
  useEffect(() => {
    triggerAutoSave()
  }, [siteName, siteUrl, contactEmail, gdprContactName, logoDisplayMode, gtmCode, customHeaderCode, customFooterCode, customHttpHeaders, adminFooterCopyright, forceHttps, seoSettings, socialLinks])
  ...
  const handleCropComplete = async (croppedBlob: Blob) => {
    ...
    try {
      ...
      console.error('[ADMIN] Logo save error:', error)
      setSaveStatus('error')
  ...
  const handleOgImageChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      ...
      try {
        ...
        console.error('[ADMIN] OG Image save error:', error)
        setSaveStatus('error')
  ...
  const handleRemoveOgImage = async () => {
    ...
    try {
      ...
      if (!res.ok) throw new Error('Failed to remove OG image')
    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="general" className="space-y-4">
        <TabsList>
          ...
          <TabsTrigger value="pages" className="data-[state=active]:bg-[#CD7F32] data-[state=active]:text-white">
            Pages ACL
          </TabsTrigger>
        </TabsList>
                ...
                <div className="pt-4 border-t">
                  ...
                  <div className="flex items-center justify-between p-4 bg-muted rounded-lg">
                    ...
                    <Button
                      ...
                      size="sm"
                      className={!forceHttps ? "bg-[#CD7F32] hover:bg-[#B8691C]" : ""}
          ...
          <div className="mt-6">
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  <h3 className="text-sm font-semibold mb-3 flex items-center gap-2">
                    <Share2 className="h-4 w-4 text-[#CD7F32]" />
                    Open Graph Metadata
                  </h3>
                ...
                <div className="pt-4 border-t">
                  <h3 className="text-sm font-semibold mb-3 flex items-center gap-2">
                    <Globe className="h-4 w-4 text-[#CD7F32]" />
                    Social Media Links
                  </h3>
